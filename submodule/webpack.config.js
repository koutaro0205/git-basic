...
module.exports = {
  // モジュールバンドル（モジュールを一つのファイルにまとめる）を行う起点となるファイルの指定
  ...
  output: {
    ...
    filename: '[name].js'  // [name]はentryで記述した名前（この設定ならbundle）が紐づく
  },
  ...
  devServer: {
    static: {
      directory: path.resolve(__dirname, 'dist'), // webpack-dev-serverの公開フォルダ
    },
